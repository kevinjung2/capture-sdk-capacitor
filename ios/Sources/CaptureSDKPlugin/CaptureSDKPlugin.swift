...
public class CaptureSDKPlugin: CAPPlugin, CAPBridgedPlugin {
    ...
    func setCallbacks(){
        ...
        implementation.eventCallbacksData.append { device, decodedData, string in self.notifyListeners("DecodedDataRecieved", data: ["device": device, "decodedData": decodedData, "string": string])
        }
        
        func initCapture(_ call: CAPPluginCall) {
            setCallbacks()
        ...
        func setFavorite(_ call: CAPPluginCall) {
